\begin{titlepage}
    ...
    {\fontsize{14}{18}\selectfont\textbf{Đánh giá hiệu quả ứng dụng khai phá quy trình (Process Mining)\\ trong phân tích học tập nhằm tối ưu hóa lộ trình cá nhân hóa\\ của sinh viên đại học}\\} 
    ...
    {\fontsize{12}{14}\selectfont\textit{\textbf{Học phần:} Xử lý dữ liệu thực nghiệm}\\} 
