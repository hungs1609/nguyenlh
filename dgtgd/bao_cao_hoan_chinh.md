# XÂY DỰNG MÔ HÌNH ĐÁNH GIÁ SỰ TIẾN BỘ CỦA SINH VIÊN ĐẠI HỌC DỰA TRÊN PROCESS MINING TRONG PHÂN TÍCH HỌC TẬP

Báo cáo đánh giá tiền khả thi về việc xây dựng mô hình đánh giá sự tiến bộ của sinh viên đại học dựa trên kỹ thuật Process Mining (Khai phá Quy trình). Nghiên cứu được đặt trong bối cảnh Phân tích Học tập trên các Hệ thống Quản lý Học tập nhằm hỗ trợ đổi mới công tác đo lường và đánh giá trong giáo dục đại học.
...
1. Xác định các yêu cầu dữ liệu tối thiểu và rà soát mức độ sẵn có của nhật ký sự kiện trên Hệ thống Quản lý Học tập phục vụ việc mô hình hóa chuỗi quy trình học tập.
2. Đề xuất khung bộ chỉ số định lượng sự tiến bộ dựa trên độ phù hợp quy trình và nhịp độ hoàn thành hoạt động học tập ở mức thiết kế khái niệm.
3. Xác lập bộ tiêu chí và các ngưỡng quyết định tiếp tục hoặc dừng nghiên cứu (Go/No-go) làm căn cứ chuyển sang giai đoạn thực nghiệm đầy đủ.

### 1.5. Câu hỏi nghiên cứu
1. Sự tiến bộ học tập của sinh viên đại học có thể được định lượng từ dữ liệu nhật ký sự kiện trên Hệ thống Quản lý Học tập bằng các kỹ thuật Process Mining theo khung khái niệm và bộ chỉ số nào?
2. Dữ liệu nhật ký sự kiện, hạ tầng kỹ thuật, điều kiện tổ chức và các yêu cầu đạo đức hiện có đáp ứng ở mức độ nào so với các yêu cầu tối thiểu của mô hình đánh giá sự tiến bộ?
3. Những rủi ro chính nào có thể phát sinh, và bộ tiêu chí cùng các ngưỡng quyết định nào cần được thỏa mãn để quyết định triển khai nghiên cứu thực nghiệm đầy đủ và đề xuất giải pháp?
...
* Giai đoạn 1 tập trung thu thập và tiền xử lý dữ liệu nhật ký sự kiện từ Hệ thống Quản lý Học tập.
* Giai đoạn 2 thực hiện phân tích Process Mining bao gồm Khám phá quy trình và Kiểm tra độ phù hợp quy trình trên tập dữ liệu rà soát.
...
1. Làm sạch và chuẩn hóa dữ liệu: Loại bỏ các bản ghi nhiễu, xử lý dữ liệu trùng lặp và chuyển đổi dữ liệu thô sang định dạng chuẩn XES (eXtensible Event Stream) hoặc CSV.
2. Khám phá quy trình: Áp dụng thuật toán Inductive Miner để rút ra Mô hình quy trình tham chiếu do giảng viên thiết kế và Mô hình quy trình thực tế của từng sinh viên.
3. Tính toán chỉ số tiến bộ: Sử dụng phép đối sánh chuỗi để xác định điểm số phù hợp và đo lường mức độ trôi lệch hành vi qua từng cửa sổ thời gian.

## III. KẾT QUẢ NGHIÊN CỨU

### 3.1. Câu hỏi nghiên cứu 1: Khả thi về khái niệm - Khung bộ chỉ số Tiến bộ Quy trình (PPM)
...
1. Nhóm Tiến bộ vượt bậc bao gồm các sinh viên hoàn thành tốt lộ trình chuẩn, học tập linh hoạt và duy trì vận tốc cao.
2. Nhóm Tiến bộ ổn định bao gồm các sinh viên duy trì nhịp độ đạt yêu cầu và tuân thủ lộ trình học tập.
3. Nhóm Nguy cơ thụt lùi hoặc Gặp điểm nghẽn bao gồm các sinh viên có chỉ số tuân thủ thấp, lặp lại sai sót hoặc dậm chân tại một bài học.

### 3.2. Câu hỏi nghiên cứu 2: Khả thi về dữ liệu, kỹ thuật, tổ chức và đạo đức
...
### 3.3. Câu hỏi nghiên cứu 3: Cơ chế gợi ý lộ trình cá nhân hóa & Bộ tiêu chí Go/No-go
...
#### 3.3.1. Ma trận Động cơ Gợi ý Lộ trình Học tập Cá nhân hóa
Dựa trên kết quả phân loại từ Điểm Tiến bộ Chuỗi (LPS), Động cơ gợi ý đề xuất các tác động tương ứng cho từng nhóm học viên:
* Đối với Nhóm Tiến bộ vượt bậc, hệ thống tự động gợi ý bỏ qua các nội dung phụ trùng lặp, mở khóa sớm các bài học tiếp theo và đề xuất các bài tập nâng cao.
* Đối với Nhóm Tiến bộ ổn định, hệ thống khuyến nghị tiếp tục duy trì lộ trình chuẩn, đồng thời bổ sung các câu hỏi tự luyện để củng cố kiến thức.
* Đối với Nhóm Nguy cơ hoặc Gặp điểm nghẽn, hệ thống tự động nhắc nhở các bài học chưa hoàn thành, đề xuất các đoạn video ngắn ôn tập nội dung bị nghẽn, đồng thời gửi cảnh báo đến giảng viên để kịp thời can thiệp trực tiếp.

#### 3.3.2. Bộ tiêu chí và Ngưỡng quyết định (Go/No-go) cho giai đoạn nghiên cứu đầy đủ
...
**Bảng 2. Bộ tiêu chí và ngưỡng quyết định (Go/No-go) cho giai đoạn nghiên cứu đầy đủ**

| Tiêu chí đánh giá | Ngưỡng tối thiểu để tiếp tục (Go) | Phương pháp kiểm chứng |
| :--- | :--- | :--- |
| **Độ sẵn có của nhật ký** | Ít nhất 1 học phần có nhật ký sự kiện liên tục $\ge 10$ tuần, quy mô $\ge 150$ sinh viên. | Rà soát cơ sở dữ liệu trên Hệ thống Quản lý Học tập. |
...
### 4.1. Bình luận kết quả nghiên cứu #1
...
### 4.2. Bình luận kết quả nghiên cứu #2
...
### 4.3. Bình luận kết quả nghiên cứu #3
...
1. Mức độ tương quan thực tế giữa Điểm Tiến bộ Chuỗi (LPS) và các thước đo kết quả học tập độc lập.
2. Giá trị thông tin bổ sung của chuỗi thứ tự hành vi so với các chỉ số tần suất tương tác truyền thống.
3. Tác động hai mặt của cơ chế cảnh báo tự động đối với động lực học tập của nhóm sinh viên có kết quả thấp.

### 4.4. Hạn chế nghiên cứu và định hướng nghiên cứu
...
### 5.2. Đối với giảng viên và người thiết kế khóa học
...
### 5.3. Đối với các đơn vị phát triển giải pháp EdTech
...
2. Bannert, M., Reimann, P., & Sonnenberg, C. (2014). Process mining techniques for analysing patterns and strategies in students’ self-regulated learning. *Metacognition and Learning*, 9(2), 161–185. https://doi.org/10.1007/s11409-013-9107-6
3. Bogarín, A., Cerezo, R., & Romero, C. (2018). A survey on educational process mining. *WIREs Data Mining and Knowledge Discovery*, 8(1), e1230. https://doi.org/10.1002/widm.1230
4. Carmona, J., van Dongen, B., Solti, A., & Weidlich, M. (2018). *Conformance checking: Relating processes and models*. Springer. https://doi.org/10.1007/978-3-319-99414-7
5. Chen, X., Zou, D., & Xie, H. (2021). Fifty years of personalized learning: A critical review and dynamic meta-analysis. *Educational Research Review*, 33, 100388. https://doi.org/10.1016/j.edurev.2021.100388
6. De Weerdt, J., De Backer, M., Vanthienen, J., & Baesens, B. (2012). A multi-dimensional quality assessment framework for process mining output. *IEEE Transactions on Knowledge and Data Engineering*, 24(7), 1330–1343.
7. Gašević, D., Dawson, S., & Siemens, G. (2015). Let’s not forget: Learning analytics are about learning. *TechTrends*, 59(1), 64–71. https://doi.org/10.1007/s11528-014-0822-x
8. Jovanović, J., Gašević, D., Dawson, S., Pardo, A., & Mirriahi, N. (2017). Learning analytics to unveil self-regulated learning strategies. *The Internet and Higher Education*, 33, 74–85. https://doi.org/10.1016/j.iheduc.2017.01.001
9. Kinnebrew, J. S., Loretz, K. M., & Biswas, G. (2013). A contextualized sequence mining approach for analyzing student behavior in open-ended learning environments. *IEEE Transactions on Learning Technologies*, 6(3), 225–237.
10. Kuzilek, J., Hlosta, M., & Zdrahal, Z. (2017). Open University Learning Analytics dataset. *Scientific Data*, 4, 170171. https://doi.org/10.1038/sdata.2017.171
11. Leemans, S. J., Fahland, D., & van der Aalst, W. (2013). Discovering block-structured process models from event logs - a robust mining technique. In *Petri Nets and Other Models of Concurrency* (pp. 310–329). Springer.
12. Maldonado-Mahauad, J., Pérez-Sanagustín, M., Moreno-Marcos, P. M., Kovanović, V., & Dawson, S. (2018). Mining theory-based self-regulated learning behaviors in MOOCs. *Computers & Education*, 127, 261–276. https://doi.org/10.1016/j.compedu.2018.09.003
13. Matcha, W., Gašević, D., & Pardo, A. (2019). A systematic review of empirical studies on learning analytics dashboards. *IEEE Transactions on Learning Technologies*, 13(2), 226–243.
14. Mukala, P., Buijs, J. C., Leemans, S. J., & van der Aalst, W. (2015). Learning patterns analysis using process mining. *Proceedings of the 8th International Conference on Educational Data Mining*, 320–327.
15. Nguyen, A., & Gardner, L. (2021). Process mining in higher education: A systematic literature review. *Educational Information Technologies*, 26(3), 3415–3439. https://doi.org/10.1007/s10639-020-10416-2
16. Romero, C., & Ventura, S. (2020). Educational data mining and learning analytics: An updated survey. *WIREs Data Mining and Knowledge Discovery*, 10(3), e1355. https://doi.org/10.1002/widm.1355
17. Schoor, C., & Bannert, M. (2012). Exploring regulatory processes during a computer-supported collaborative learning task using process mining. *Computers in Human Behavior*, 28(4), 1321–1331.
18. Sedrakyan, G., Snoeck, M., & De Weerdt, J. (2018). Process mining for tracking student learning trajectories in higher education. *IEEE Transactions on Learning Technologies*, 11(4), 488–501. https://doi.org/10.1109/TLT.2018.2830325
19. Siemens, G., & Long, P. (2011). Penetrating the fog: Analytics in learning and education. *EDUCAUSE Review*, 46(5), 30–32.
20. Tempelaar, D. T., Rienties, B., & Giesbers, B. (2015). In search of the most informative data for learning analytics. *Computers in Human Behavior*, 47, 157–167. https://doi.org/10.1016/j.chb.2014.05.038
21. Trčka, N., Pechenizkiy, M., & van der Aalst, W. (2010). Process mining from educational data. In C. Romero, S. Ventura, M. Pechenizkiy, & R. Baker (Eds.), *Handbook of Educational Data Mining* (pp. 123–142). CRC Press.
22. Van der Aalst, W. M. P. (2016). *Process mining: Data science in action* (2nd ed.). Springer. https://doi.org/10.1007/978-3-662-49851-4
23. Vibo, M., & Schoor, C. (2021). Analyzing sequential and temporal learning process data. *Journal of Educational Psychology*, 113(4), 812–829.
24. Winne, P. H., & Baker, R. S. J. d. (2013). The potentials of educational data mining for researching metacognition, motivation and self-regulated learning. *Journal of Educational Data Mining*, 5(1), 1–8.
25. Zheng, J., Li, S., & Huang, L. (2022). Personalized learning path recommendation based on process mining and reinforcement learning. *Computers & Education*, 182, 104478. https://doi.org/10.1016/j.compedu.2022.104478
