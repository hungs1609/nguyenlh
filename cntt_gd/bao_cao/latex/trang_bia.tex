\begin{titlepage}
    ...
    {\fontsize{14}{18}\selectfont\textbf{Ứng dụng AI tạo sinh hỗ trợ giảng viên\\ tự động tạo học liệu và thiết kế hoạt động dạy học\\ tại Đại học Bách khoa Hà Nội}\\} 
    ...
    {\fontsize{12}{14}\selectfont\textit{\textbf{Học phần:} Công nghệ thông tin trong giáo dục}\\} 
