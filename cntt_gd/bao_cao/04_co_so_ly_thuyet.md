...
### 4.1. Trí tuệ nhân tạo tạo sinh và mô hình ngôn ngữ lớn trong giáo dục

#### 4.1.1. Khái niệm và nguyên lý hoạt động của trí tuệ nhân tạo tạo sinh
...
#### 4.1.2. Prompt engineering trong giáo dục đại học
*Prompt engineering* là kỹ thuật thiết kế và tinh chỉnh các câu lệnh đầu vào nhằm định hình phản hồi của mô hình ngôn ngữ lớn theo mục tiêu cụ thể. Trong môi trường giáo dục đại học, *prompt engineering* đóng vai trò quan trọng quyết định chất lượng học liệu do công nghệ tạo ra. Việc thiết kế câu lệnh bao gồm việc phân định rõ câu lệnh hệ thống để xác định vai trò chuyên môn của mô hình, các kỹ thuật gợi ý kèm ví dụ mẫu để định hình định dạng dữ liệu đầu ra, và kỹ thuật đóng vai nhằm mô phỏng tư duy của một chuyên gia sư phạm. Áp dụng đúng các kỹ thuật này giúp giảng viên kiểm soát cấu trúc thông tin đầu ra, tránh các phản hồi chung chung và tập trung vào các kiến thức kỹ thuật chuyên sâu.

#### 4.1.3. Ứng dụng thực tiễn của trí tuệ nhân tạo tạo sinh trong soạn thảo học liệu
...
#### 4.1.4. Những giới hạn và thách thức học thuật
...
### 4.2. Thang đo nhận thức Bloom và đánh giá kết quả học tập

#### 4.2.1. Cấu trúc thang đo nhận thức Bloom cải tiến
Thang đo nhận thức Bloom cải tiến là khung lý thuyết phân loại các mục tiêu học tập và mức độ tư duy thành sáu cấp độ nhận thức từ thấp đến cao. Cấp độ thứ nhất là nhớ, liên quan đến khả năng nhận biết và tái hiện các định nghĩa hoặc dữ kiện đã học. Cấp độ thứ hai là hiểu, yêu cầu người học giải thích ý nghĩa, phân loại hoặc tóm tắt thông tin. Cấp độ thứ ba là áp dụng, đòi hỏi việc vận dụng kiến thức lý thuyết để giải quyết các bài tập hoặc tình huống cụ thể. Cấp độ thứ tư là phân tích, yêu cầu chia nhỏ thông tin để làm rõ cấu trúc và mối quan hệ giữa các thành phần. Cấp độ thứ năm là đánh giá, đòi hỏi người học đưa ra nhận định hoặc phê phán giải pháp dựa trên các tiêu chí chuẩn hóa. Cấp độ thứ sáu là sáng tạo, yêu cầu tổng hợp các yếu tố để xây dựng phương án hoặc sản phẩm mới.

#### 4.2.2. Vai trò của thang Bloom trong thiết kế học liệu đánh giá
...
#### 4.2.3. Khả năng tích hợp trí tuệ nhân tạo để sinh câu hỏi theo thang Bloom
...
### 4.3. Thuyết kiến tạo và thiết kế hoạt động dạy học chủ động

#### 4.3.1. Nguyên lý cơ bản của thuyết kiến tạo
...
#### 4.3.2. Thiết kế hoạt động dạy học tích cực
...
#### 4.3.3. Ứng dụng trí tuệ nhân tạo tạo sinh trong đề xuất hoạt động dạy học kiến tạo
